package com.lambton.androidgame;

import android.support.v7.app.AppCompatActivity;
import android.os.Bundle;
import com.lambton.androidgame.GameBoard;
import com.lambton.androidgame.R;
import android.os.Bundle;
...
public class MainActivity extends AppCompatActivity implements OnClickListener {
    ...
    synchronized public void initGfx() {
        ...
        do {
            p1 = getRandomPoint();
            p2 = getRandomPoint();
            p3 = new Point(findViewById(R.id.the_canvas).getWidth()/2,findViewById(R.id.the_canvas).getHeight()/2);
        ...
        sprite2Velocity = new Point(10,10);
        sprite3Velocity = new Point(0,0);
        ...
        synchronized public void run() {
            ...
            if (((GameBoard)findViewById(R.id.the_canvas)).wasCollisionDetected()) {
                ...
                if (collisionPoint.x>=0) {
                    ...
                    ((TextView)findViewById(R.id.the_label)).setText("Game Status: GAME OVER");
                }
